...
function Create() {
    ...
    const sendData = async (e) => {
        ...
        if (Object.keys(validationUserData(user)).length > 0)
            ...
            // const { data } = await axios.post("https://crud-users-gold.vercel.app/users/", user).catch((error)=>{
            ...
            <div className="row flex-nowrap">
                ...
                <div className="col py-3">
                    ...
                    <form onSubmit={sendData}>
                        <Input id={'userName'} title={'User Name'} type={'text'} name={'name'} errors={errors} handleData={handleData} />
                        <Input id={'email'} title={'Email'} type={'email'} name={'email'} errors={errors} handleData={handleData} />
                        <Input id={'password'} title={'Password'} type={'password'} name={'password'} errors={errors} handleData={handleData} />

                        <div className="mb-3">
                            <input type='submit' className='form-control bg-primary text-white' value='Add User' />
                        </div>
                    </form>
                </div>
            </div>
